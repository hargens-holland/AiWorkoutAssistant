...
export class GoogleCalendarService {
    ...
    // Create a generic Google Calendar event
...
// Export the createGoogleCalendarEvent function for direct use
export async function createGoogleCalendarEvent(eventData: {
    ...
    return await googleCalendarService.createGoogleCalendarEvent(eventData);
}
